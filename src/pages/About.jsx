/**
 * About.jsx
 * Company history, leadership, core values, certifications, and CTA.
 * 100% static. Company data sourced from lib/constants.js.
 */
...
// ─── Image assets ──────────────────────────────────────────────────────────────
const IMAGES = {
  hero:   'https://media.base44.com/images/public/6a106c8a1a9a374d55e747f9/1c7a0ae49_generated_17757b83.png',
...
const VALUES = [
  {
    title: 'Integrity',
    desc: 'We operate with complete transparency and honesty in all our business dealings, maintaining the trust of partners, clients, and stakeholders.',
  },
  {
    title: 'Excellence',
    desc: 'Every barrel of crude oil and every refined product we deliver meets the strictest international quality standards.',
  },
  {
    title: 'Safety First',
    desc: 'The health and safety of our employees, contractors, and surrounding communities is our non-negotiable priority.',
  },
  {
    title: 'Sustainability',
    desc: 'We are committed to environmentally responsible operations, minimizing our ecological footprint with every decision we make.',
  },
  {
    title: 'Innovation',
    desc: 'We embrace modern technologies and methodologies in petroleum extraction and refining to maximize efficiency and output.',
  },
  {
    title: 'Community',
    desc: 'As a Kazakhstani enterprise, we invest in local communities, provide employment, and contribute to regional economic growth.',
  },
];
    ...
    <div className="min-h-screen bg-[#181418] text-white">
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0">
          <img src={IMAGES.hero} alt="Refinery" className="w-full h-full object-cover opacity-25" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-black font-['Playfair_Display'] mb-6 leading-tight">
            Built on <span className="text-[#a93134]">Integrity,</span><br />
            Driven by <span className="text-[#a93134]">Excellence</span>
          </h1>
          <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
            A Kazakhstani oil refinery enterprise with a legacy of quality, safety, and commitment
            to the energy future of Central Asia.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-5">
                {COMPANY.name} was established as an operating enterprise dedicated to the exploration,
                extraction, and refining of petroleum resources in the Almaty Region of Kazakhstan.
                Since our founding, we have grown into one of the region's most respected oil and gas enterprises.
              </p>
              <p className="text-gray-400 leading-relaxed mb-5">
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                Under the guidance of our Head,{' '}
                <strong className="text-white">{COMPANY.head}</strong>, the company has maintained
                unwavering standards in quality, environmental stewardship, and employee welfare.
              </p>
              <ul className="space-y-3">
                {[
                  'Crude oil and associated gas production in Almaty Region',
                  'Certified to international ISO standards',
                  'Committed to local community development',
                  'Transparent and compliant with Republic of Kazakhstan regulations',
                ].map((item) => (
            ...
            <div className="relative mt-8 lg:mt-0">
              <img
                ...
                className="rounded-xl border border-[#4a444d]/30 w-full aspect-[4/3] object-cover"
              />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#181418] rounded-xl border border-[#4a444d]/30 p-7 hover:border-[#a93134]/30 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">{COMPANY.head}</p>
            ...
            <div className="bg-[#181418] rounded-xl border border-[#4a444d]/30 p-7 hover:border-[#a93134]/30 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">{COMPANY.address}</p>
            </div>
            ...
            <div className="bg-[#181418] rounded-xl border border-[#4a444d]/30 p-7 hover:border-[#a93134]/30 transition-colors">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">BIN: {COMPANY.bin}</p>
              <p className="text-gray-500 text-xs mt-2">OKED: {COMPANY.oked}</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VALUES.map((v, i) => (
              <div
                key={v.title}
                className="bg-[#0f0d0f] rounded-xl border border-[#4a444d]/30 p-6 hover:border-[#a93134]/30 transition-all duration-300"
              >
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-[#a93134]/40 text-5xl font-black font-['Playfair_Display'] leading-none">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-px bg-[#a93134]" />
                <span className="text-[#a93134] text-xs tracking-[0.3em] uppercase font-semibold">
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                ...
                and the regulatory requirements of the Republic of Kazakhstan.
              </p>
              <div className="flex flex-wrap gap-3">
                {CERTIFICATIONS.map((cert) => (
                  <div
                    key={cert}
                    className="flex items-center gap-2 bg-[#181418] border border-[#4a444d]/40 rounded-full px-4 py-2"
                  >
            ...
            <div>
              <img
                ...
                className="w-full rounded-xl border border-[#4a444d]/30 aspect-[4/3] object-cover"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Contact us today to learn more about our products and services, or submit a service
            request and one of our representatives will reach out to you.
          </p>
          <Link
            to="/request-service"
