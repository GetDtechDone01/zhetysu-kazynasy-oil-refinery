/**
 * ThankYou.jsx
 * Confirmation page shown after the service request form is submitted.
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-32">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-gray-400 leading-relaxed mb-4">
            Your service request has been sent. A representative from {COMPANY.name} will
            review your enquiry and respond directly to your email address.
          </p>

          <p className="text-gray-500 text-sm mb-10">
            We typically respond within{' '}
            <strong className="text-gray-300">24 business hours</strong>.
            For urgent matters, contact us directly at{' '}
            <a href={`mailto:${COMPANY.email}`} className="text-[#a93134] hover:underline">
              {COMPANY.email}
            </a>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#a93134] hover:bg-[#c0404a] text-white font-semibold rounded-full transition-all duration-200 hover:shadow-xl hover:shadow-[#a93134]/30"
            >
