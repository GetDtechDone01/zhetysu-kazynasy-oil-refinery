      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6 font-['Playfair_Display']">
              Powering <br />
        ...
        {/* Stats bar */}
        <div className="absolute bottom-0 left-0 right-0 border-t border-[#4a444d]/30 bg-[#181418]/80 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-24 h-24 border border-[#a93134]/30 rounded-lg" />
              <img src={ABOUT_IMG} alt="About" className="w-full rounded-xl object-cover aspect-[4/3] relative z-10 border border-[#4a444d]/30" />
              <div className="absolute -bottom-4 -right-4 w-24 h-24 border border-[#6a1b20]/40 rounded-lg" />
            </div>
            <div>
